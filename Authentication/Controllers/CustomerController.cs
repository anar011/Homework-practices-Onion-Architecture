...
namespace Authentication.Controllers
{
    public class CustomerController
    {
        ...
        //{
        //    //Console.WriteLine((int)_service.GetCustomersAverageByAges());
        ...
        public void GetCustomersByFiltered()
        {
            ...
            foreach(var item in result)
            {
                if(item != null)
                {
                    ...
                    {
                        Console.WriteLine("Emeliyyat duzgun deil");
                    }
            ...
            //Console.WriteLine(_service.GetCustomersByFiltered(startAge, endAge));
